...
from swap.server.lp_contest import LPContest, get_lp_contest, get_lp_contest_block, get_lp_contest_percentile
...
class Query:
    ...
    lp_contests: List[LPContest] = strawberry.field(resolver=get_lp_contest)
    lp_contest_blocks: List[LPContest] = strawberry.field(resolver=get_lp_contest_block)
    lp_contest_percentile: str = strawberry.field(resolver=get_lp_contest_percentile)
